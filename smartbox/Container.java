...
public class Container extends Model {
    ...
    public void addComponent(String name) throws Exception {
        ...
        Class<?> compName = Class.forName(qualName);
        // Object obj = a new instance of qualName
        Object obj = compName.getDeclaredConstructor().newInstance();
...
//                System.out.println(provider+" provides " + intf.getName() + " for " + client);
    ...
    public void launch(String name) throws Exception {
        try {
            ...
            Utilities.error("This class is not runnable");
        }
    }
